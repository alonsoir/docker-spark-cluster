...
# SPARK_APPLICATION_JAR_LOCATION="/opt/spark-apps/learning-spark-mini-example_2.11-0.0.1.jar"
# I am using fish shell, so in my particular case, i have to use:
set SPARK_APPLICATION_JAR_LOCATION /opt/spark-apps/learning-spark-mini-example_2.11-0.0.1.jar
...
docker run --network docker-spark-cluster_spark-network -v /tmp/spark-apps:/opt/spark-apps --env SPARK_APPLICATION_ARGS="/opt/spark-data/README.md /opt/spark-data/output-10" --env SPARK_APPLICATION_JAR_LOCATION=$SPARK_APPLICATION_JAR_LOCATION --env SPARK_APPLICATION_MAIN_CLASS=$SPARK_APPLICATION_MAIN_CLASS spark-submit:2.4.0
